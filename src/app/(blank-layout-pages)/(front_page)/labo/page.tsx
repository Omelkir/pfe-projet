...
const Laboratoire = () => {
  ...
  async function getLaboratoireList(page = 1) {
    try {
      const url = `${window.location.origin}/api/liste-labo-ser/liste?nom_ut=${data.nom_ut}&mode_pre=${data.mode_pre}&id_ville=${data.id_ville}&approuve=1&archive=0&page=${page}`
